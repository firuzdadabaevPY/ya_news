...
class CommentCreation(TestCase):
    ...
    def test_anonymous_user_cant_create_comment(self):
        ...
        coments_count = Comment.objects.count()
        self.assertEqual(coments_count, 0)
    ...
    def test_user_cant_use_bad_words(self):
        ...
        self.assertFormError(
            response,
            form='form',  # имя формы (как оно указано в словаре context),
            field='text',  # имя поля формы, ошибку которого нужно протестировать,
            errors=WARNING  # ожидаемый текст ошибки или список ошибок.
        )
        comments_count = Comment.objects.count()
